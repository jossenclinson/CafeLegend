...
public class FragmentAppetizer extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        itemListVector.add(new ItemList("Gravlax", "A Nordic dish made of cured salmon infused with fresh dill, vodka (optional) and seasonings. A good bagel goes well with this appetizing treat.",34000, R.drawable.p10));
        itemListVector.add(new ItemList("Korean Pancake", "These Korean pancakes are so so addictive! Don’t think they’re just some ordinary pancakes. These babies will take you on a culinary adventure. With seafood in the mix, this could be my breakfast.", 23000, R.drawable.p11));
        itemListVector.add(new ItemList("Mexican Queso Fundido", "Layers of ooey gooey melted cheese loaded with spicy chorizo sausage. How can you resist?!! For Cinco de Mayo, nothing could be more perfect. Serve it with red, white, and blue tortilla chips and they could be what your Fourth of July cookout needs.", 30000, R.drawable.p12));
        itemListVector.add(new ItemList("Malaysian Chicken Satay", "The best chicken satay you’ll ever have with its oriental flair and exotic flavors! The shallots, turmeric, and lemongrass mixture of seasonings will leave a taste in your mouth that will surely boost your appetite.", 22000, R.drawable.p13));

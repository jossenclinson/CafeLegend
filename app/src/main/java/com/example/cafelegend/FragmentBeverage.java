...
public class FragmentBeverage extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        itemListVector.add(new ItemList("Mango Lassi", "Some of India's lucky workers have migrated into the air-conditioned confines of its call centers and IT offices. For the rest, and for travelers there, reprieve comes in the form of a cooling, sweat-beating summer drink that acts like an internal sun screen.", 25000, R.drawable.p0));
        itemListVector.add(new ItemList("Pina Colada", "Just looking at the drink brings you closer to a beach and sipping this mixture of coconut milk, pineapple juice and rum will send you directly to a hammock between palm trees in the Caribbean.", 28000, R.drawable.p1));
        itemListVector.add(new ItemList("Cendol", "Strictly speaking this is more of a watery dessert than a drink, and is served in a bowl, but at least that way you get to take bigger gulps. The mixture of creamy coconut milk and sweet palm sugar chilled by shaved ice will is the perfect antidote to the hawkers on Kuta beach.", 17000, R.drawable.p2));
        itemListVector.add(new ItemList("Chocolate Milkshake", "This artery-clogging third musketeer (after burger and fries) of the fast-food world gives a sweet ending to all family meals out. And it may not even be as fattening as you think -- the amount of energy spent trying to slurp this thick sludge up the straw must burn off at least a few of those calories.", 64000, R.drawable.p3));
        itemListVector.add(new ItemList("Eggnog", "Bring in the eggnog and the otherwise long and torturous family gathering where everyone wears hideous sweaters turns into a joyous Christmas dinner. This sweetened beverage of milk and beaten eggs tastes like an alcoholic creamy egg custard. Best served warm.", 65000, R.drawable.p4));
    }
